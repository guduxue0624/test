...
/*******************************************************************************
 * 名称: webSocket_buildClientHeader
...
/*******************************************************************************
 * 名称: webSocket_buildServerResponder
...
int webSocket_clientLinkToServer(char *ip, int port, char *interface_path)
{
	...
	webSocket_buildClientHeader(ip, port, interface_path, shakeKey, (char *)loginBuf);   
	//发出协议包
...
int webSocket_serverLinkToClient(int fd, char *recvBuf, int bufLen)
{
    ...
    webSocket_buildServerResponder((unsigned char *)recvShakeKey, (unsigned int)ret, respondPackage);
    //
